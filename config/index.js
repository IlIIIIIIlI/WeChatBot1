...
module.exports = {
    ...
    NAME: '乖宝', //女朋友备注姓名
    NICKNAME: '乖宝', //女朋友昵称
    MEMORIAL_DAY: '2022/05/18', //你和女朋友的纪念日
    CITY: '墨尔本', //女朋友所在城市（城市名称，不要带“市”）
    SENDDATE: '0 36 16 * * *', //定时发送时间 每天8点06分0秒发送，规则见 /schedule/index.js
    ...
    AUTOREPLYPERSON: ['Andy', 'Becky', 'Becky2'], //指定多个好友开启机器人聊天功能   指定好友的备注，最好不要带有特殊字符
